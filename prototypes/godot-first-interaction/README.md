...
## Fungus farm and hanging garden

Question: does the colony read as a fungus farmer whose success you can see from a distance, rather than a mound that eats plants?
...
This optional starting fixture seeds finite plants and a small living fungus garden once and gives the Astronaut the opened cache and Field Scanner. Ordinary ecology, weather, survival, habitat departure and toolkit controls continue running. **R** restarts the same fixture. Use **WASD** to observe from nearby, **T** to move a robust clump, **Space** to water, and **J** to pause. Carriers show green plant fragments; every visible worker corresponds to authoritative worker state. There is no ordinary-play scent overlay or assigned food target. This experiment concerns established-colony workers; queen waking is described above.
