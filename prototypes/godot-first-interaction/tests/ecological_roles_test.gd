...
func _init() -> void:
	...
	ecology.add_resources(vector_cell + Vector2i(2, 0), {"rhizome": 0.42, "ground_bloom": 0.28})
	for cell in [vector_cell, vector_cell + Vector2i(2, 0)]:
		ecology.moisture[cell.y * ecology.WIDTH + cell.x] = 0.6
		ecology.toxicity[cell.y * ecology.WIDTH + cell.x] = 0.0
