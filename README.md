...
Automated regressions establish that these systems behave consistently; they do not prove that the habitat changes, spatial puzzle, or path to First Rain are understandable or enjoyable. Issue #28 therefore remains open pending its explicit playtest gate. Prototype quantities, timings, thresholds, visuals, and one-off fixtures are evidence for decisions rather than final production content.
