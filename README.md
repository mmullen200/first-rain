...
Organisms matter because of the roles they perform. The current experiment makes their local dependencies explicit: Microbial Crust prepares damp loose ground; moss retains water and supplies Detritus; fungus decomposes dead matter and detoxifies ground; Rooted Mats build on that pioneer substrate but begin competing for water and nutrients; and Ground Flowering creates an offer that a Flying Reproductive Vector must carry between separated patches. That connection permits the much slower Canopy-Former to wake, after which forage beside cover can support grazers. A fixed Eusocial Colony arrives before the Flying Reproductive Vector and redistributes small loads of plant material around its nest. Wetland Engineers arrive late enough to redirect established drainage, while the predator remains the most fragile and last animal role.

This is a Successional dependency sequence, not a global unlock ladder or a ranking of evolutionary advancement. Different cells can occupy different stages at once, stages can collapse, and the player needs a spatial Ecological Mosaic rather than one uniformly lush patch.
